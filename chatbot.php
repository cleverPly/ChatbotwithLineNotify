...
//fwrite($myfile,$json);
//fclose($myfile);
$noti_token = ‘EWFmYvAr3eEOP7l6Q0D0bcBAGuFxGkzubysXKil4Z5z’;
date_default_timezone_set(“Asia/Bangkok”);
...
$message_all = ‘[LineChatbot] ‘.$name_.’ ถามว่า ‘.$message.’ ‘.’https://siitseniorchatbot.azurewebsites.net/push11.php?mass='.$mass;
$date_ = date(“Y-m-d”);
$time_ = date(“H:i:s”);
